...
unsigned char text1[] ={"<ss1>utkal "};
unsigned char text2[]={"<ss2>Sanjel"};
unsigned char text3[]={"<ss3>This is Message three  "};
unsigned char text4[]={"<ss4>This is Message four  "};
...
void save_as_priority(unsigned char * message){
  if(message[3]=='1'){
    strcpy(ttext1,text1);
    strcpy(ttext2,text2);
    strcpy(ttext3,text3);
    ...
    strcpy(ttext2,text2);
    strcpy(ttext3,text3);
    for(int i=100;message[i-100]!='\0';++i){
      EEPROM.write(i,text1[i-100]);
    ...
    strcpy(ttext3,text3);
    for(int i=200;message[i-200]!='\0';++i){
      EEPROM.write(i,text1[i-200]);
      text3[i-200]=message[i-200];
    }
    strcpy(text4,ttext3);
  }
   else if(message[3]='4'){
    for(int i=300;message[i-300]!='\0';++i){
      EEPROM.write(i,text1[i-300]);
...
void display_message(unsigned char * message){
  ...
  int x;
  sscanf(message[3],"%d",&x);
  //scrollMessage(message,x);
}
