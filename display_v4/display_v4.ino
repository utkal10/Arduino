...
void save_as_priority(unsigned char * message,int sizexx){
  if(message[3]=='1'){
    ...
    strcpy(text2,ttext1);
    for(int i=100;i<100+sizeof(text2)/sizeof(text2[0]);i++){
      EEPROM.write(i,message[i-100]);
      text1[i-100]=message[i-100];
    }
    strcpy(text3,ttext2);
    for(int i=200;i<200+sizeof(text3)/sizeof(text3[0]);i++){
      EEPROM.write(i,message[i-200]);
      text1[i-200]=message[i-200];
    }
    strcpy(text4,ttext3);
    for(int i=300;i<300+sizeof(text4)/sizeof(text4[0]);i++){
      EEPROM.write(i,message[i-300]);
      text1[i-300]=message[i-300];
    }
  }
  else if(message[3]='2'){
    strcpy(ttext2,text2);
